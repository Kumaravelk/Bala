...
public class CustomRetailerActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.custom_retailer_main);
		...
		cus_ret_search = (SearchView) findViewById(R.id.cus_ret_search);
	...
	class MyCategory extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(CustomRetailerActivity.this);
	...
	protected void fun_category() {
		...
		cus_ret_ex_list = (ExpandableListView) findViewById(R.id.cus_ret_expandableListView);
		btn_cus_fav_ret = (Button) findViewById(R.id.cus_fav_ret);

		adapter = new CustomRetailerExListAdapter(CustomRetailerActivity.this,
				grouplist);
	...
	class customizecategoryAsync extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialogg = new ProgressDialog(CustomRetailerActivity.this);
		...
		protected void onPostExecute(String result) {
			...
			Toast.makeText(getApplicationContext(), "Preferences Updated",
					Toast.LENGTH_LONG).show();
